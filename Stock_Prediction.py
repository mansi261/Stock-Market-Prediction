...
st.header('Stock Price Prediction using different ML Models')
...
def stock_prediciton(USER_COMPANY,initial_date,end_date):
    ...
    plot_stock.plot_stock_prices(dataset_company["Close"], Select_company+"'s Stock Price")
    ...
    plot_stock.plot_stock_prices_predicted(dataset_company[-len(x_test_lstm):], "LSTM Model for " + Select_company+"'s Stock Price Prediction ",
    ...
    plot_stock.plot_stock_prices_predicted(dataset_company[-len(arima_testing_data):], "ARIMA Model for " + Select_company+"'s Stock Price Prediction ",
